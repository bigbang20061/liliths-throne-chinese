...
public class Heather extends NPC {
	...
	public Heather(boolean isImported) {
		super(isImported, new NameTriplet("希瑟"), "星梦",
				"在伊利斯农贸市场，希瑟经营着自己的“第三只眼”摊位，[heather.she]出售药水和附魔衣物，或用占卜来换取集市票。",
				24, Month.MAY, 7,
				5,
