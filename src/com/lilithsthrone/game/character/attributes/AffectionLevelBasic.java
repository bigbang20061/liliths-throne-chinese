...
public enum AffectionLevelBasic {
	...
	/** -100 to -30*/
	DISLIKE("讨厌", -100, -30, PresetColour.AFFECTION_NEGATIVE_TWO),

	/** -30 to 30*/
	NEUTRAL("中立", -30, 30, PresetColour.AFFECTION_POSITIVE_ONE),

	/** 30 to 100*/
	LIKE("喜欢", 30, 100, PresetColour.AFFECTION_POSITIVE_FIVE);
