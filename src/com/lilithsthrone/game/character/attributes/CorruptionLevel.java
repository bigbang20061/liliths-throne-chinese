...
public enum CorruptionLevel {
	...
	ZERO_PURE("纯洁", 0, 10, PresetColour.CORRUPTION_STAGE_ZERO, 0) {
		@Override
	...
	FOUR_LUSTFUL("淫荡", 70, 90, PresetColour.CORRUPTION_STAGE_FOUR, 1f) {
		@Override
		public AbstractStatusEffect getRelatedStatusEffect() {
	...
	FIVE_CORRUPT("堕落", 90, 100, PresetColour.CORRUPTION_STAGE_FIVE, 2f) {
		@Override
		public AbstractStatusEffect getRelatedStatusEffect() {
