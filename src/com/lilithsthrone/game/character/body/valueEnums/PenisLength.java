...
public enum PenisLength {
	...
	ZERO_MICROSCOPIC("微小", 0, 5, PresetColour.GENERIC_SIZE_TWO),

	/**Average size for a harpy. (2-3 inches)*/
	ONE_TINY("短小", 5, 10, PresetColour.GENERIC_SIZE_TWO),

	/**Average size for all regular morphs. (4-7 inches)*/
	TWO_AVERAGE("平均长度", 10, 20, PresetColour.GENERIC_SIZE_THREE),

	/**Average size for a wolf morph. (8-11 inches)*/
	THREE_LARGE("较大", 20, 30, PresetColour.GENERIC_SIZE_FOUR),

	/**Average size for a horse morph. (12-15 inches)*/
	FOUR_HUGE("极大", 30, 40, PresetColour.GENERIC_SIZE_FIVE),

	/**Straying into the bounds of "world record for a human". Large for a horse morph. (16-19 inches)*/
	FIVE_ENORMOUS("硕大", 40, 50, PresetColour.GENERIC_SIZE_SIX),

	/**This is just ridiculous... World record for a horse-morph. (20-23 inches)*/
	SIX_GIGANTIC("巨大", 50, 60, PresetColour.GENERIC_SIZE_SEVEN),

	/**And this is for "extreme proportion" content. (24-40 inches)*/
	SEVEN_STALLION("马屌尺寸", 60, 100, PresetColour.GENERIC_SIZE_EIGHT);
