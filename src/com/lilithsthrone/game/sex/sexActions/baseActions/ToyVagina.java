...
//	}
	...
	public static final SexAction FORCE_TOY_OVER_VAGINA = new SexAction(
		...
		@Override
		public String getActionDescription() {
			return "挑逗[npc2.name]，把[npc2.her][npc2.cock]的[npc2.cockTip]在你[npc.pussy+]口蹭来蹭去。";
		}
				...
				default:
					return (UtilText.returnStringAtRandom(
							"[npc2.Name]热切地扭动[npc2.hips]作为回应，"
									+ "[npc2.she]热切地帮着[npc.namePos][npc.cock+]深深插入[npc2.her][npc2.pussy+]时，潮水般的快感让[npc2.she]忍不住发出[npc2.a_moan+]。",
							"[npc2.namePos][npc2.lips+]间爆发出一阵[npc2.A_moan+]，"
	...
	public static final SexAction TOY_FUCKING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"[npc.name]粗暴地将[npc.cock+]深深插入[npc2.namePos][npc2.pussy+]，"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"[npc.Name]将[npc.pussy+]向后压向[npc2.namePos]的[npc2.cock]，把它挪到[npc.labia+]之间，"
										+ "[npc.she]慢慢地向后顶，强迫[npc2.name]插入[npc.herHim]，不禁漏出一声轻柔的[npc.moan]。"));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"[npc.Name]将[npc.pussy+]向后压向[npc2.namePos]的[npc2.cock]，把它挪到[npc.labia+]之间，"
										+ "[npc.she]向后顶，强迫[npc2.name]插入[npc.herHim]，不禁漏出一阵[npc.a_moan+]。"));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"[npc.Name]饥渴地将[npc.pussy+]向后压向[npc2.namePos]的[npc2.cock]，把它挪到[npc.labia+]之间，"
										+ "[npc.she]急切地向后顶，强迫[npc2.name]插入[npc.herHim]，不禁漏出一阵[npc.a_moan+]。"));
						break;
				}
			}
