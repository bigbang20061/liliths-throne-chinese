...
//						System.out.println("res sexAction: "+node.getId());
		...
		Map<String, Field[]> sexActionClassIdToFields = Util.newHashMapOfValues(new Value<String, Field[]>("PositioningMenu", PositioningMenu.class.getFields()),
				...
				new Value<String, Field[]>("PenisPenis", PenisPenis.class.getFields()),
				new Value<String, Field[]>("PenisPenisCloaca", PenisPenisCloaca.class.getFields()),
