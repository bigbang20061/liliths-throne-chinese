...
public class Colour {
	...
	*/
	...
	public Colour getDesaturatedVersion() {
		...
		String id = getId();
		return new Colour(isMetallic(), colour.deriveColor(0, desaturationValue, brightnessValue, 1.0), lightColour.deriveColor(0, desaturationValue, brightnessValue, 1.0), "暗"+getName()) {
			@Override
			public String getId() {
				return id+"_DESAT";
			}
